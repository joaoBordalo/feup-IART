...
/** 
 * Concrete implementation of the <b>below</b> modifier. Consider the following example:
 * <br><br>
 ...
 *      </tr>
 *      <tr>
 *          <td>After <b>Below</b> modifier applied:
 *              <ul>
 ...
 */
 public class BelowModifier extends ModifierFunction implements Serializable
 {
   public BelowModifier()
    ...
    public BelowModifier(String s)
    {
        super( s );
    }

    /**
     * Creates a new FuzzyValue by applying the <b>below</b> modifier to an
     * existing FuzzyValue.
     * Below identifies the first x value
     * at which the maximum value is reached. All membership values
     * above this point are set to zero and all membership values below
     * this value are set to 1-y. For convex fuzzy sets this gives 
     * an intuitive result.  
    ...
    /**
     * Creates a new FuzzySet by applying the <b>below</b> modifier to an
     * existing FuzzySet.
     * Below identifies the first x value
     * at which the maximum value is reached. All membership values
     * above this point are set to zero and all membership values below
     ...
     * an intuitive result.  
     *
     * @param fs the fuzzy set to which the below modifier is applied.
     * @see ModifierFunction
     */
