...
/**
 * Concrete implementation of the <b>extremely</b> modifier. Consider the following example:
 * <br><br>
 ...
 */
 public class ExtremelyModifier extends ModifierFunction implements Serializable
 {
    ...
    public ExtremelyModifier(String s)
    {
        super( s );
    }
     ...
     * after the application of the <code>extremely</code> modifier.  The extremely modifier
     * raises the membership values of the points in the FuzzyValue to a power of 3.
     *
     * @param fv the FuzzyValue to modify with the <code>extremely</code> hedge
     * @return a new FuzzyValue object representing FuzzyValue argument after the 
     *         application of the <code>extremely</code> hedge.  This new FuzzyValue 
     ...
     *
     * @param fs the FuzzySet to modify with the <code>extremely</code> hedge
     * @return a new FuzzySet object representing FuzzySet argument after the 
     *         application of the <code>extremely</code> hedge.
     * @see ModifierFunction
     */

    public FuzzySet call(FuzzySet a){
        return(concentrateDilute(a, 3.0));
    }
