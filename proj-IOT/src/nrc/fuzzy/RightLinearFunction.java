 ...
 * 
 */
public class RightLinearFunction implements FuzzySetFunction, Serializable 
{
    ...
    /**
     * Create an instance of the RightLinearFunction class with
     ...
     * (linear) from with membership value 1 on the left to 0 on the right.
    ...
    public FuzzySet generateFuzzySet(double leftX, double rightX, int numPoints)
    {
        ...
        if(numPoints == 2){
            ...
            fs.set[1] = new SetPoint(rightX, 0.0);
            ...
            for(int i=1; i<numPoints-2; i++){
                fs.set[i] = new SetPoint(leftX + X, 1.0 + Y);
                X += deltaX;
                Y += deltaY;
            }
