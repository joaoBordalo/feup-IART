...
/**
 * Concrete implementaion of the <b>plus</b> modifier. Consider the following example:
 * <br><br>
 ...
 */
 public class PlusModifier extends ModifierFunction implements Serializable
 {
   public PlusModifier()
    {
        super( "plus" );
     ...
     * after the application of the <code>plus</code> modifier.  The plus modifier
     * raises the membership values of the points in the FuzzyValue to a power of 
     * 1.25.
     *
     * @param fv the FuzzyValue to modify with the <code>plus</code> hedge
     * @return a new FuzzyValue object representing FuzzyValue argument after the 
     *         application of the <code>plus</code> hedge.  This new FuzzyValue 
     ...
     * 1.25.
     *
     * @param fs the FuzzySet to modify with the <code>plus</code> hedge
     * @return a new FuzzySet object representing FuzzySet argument after the 
     *         application of the <code>plus</code> hedge.
     * @see ModifierFunction
     */
    public FuzzySet call(FuzzySet a)
    {
        return(concentrateDilute(a, 1.25));
    }
}
