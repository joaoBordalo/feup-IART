...
/**
 * Concrete implementaion of the <b>somewhat</b> modifier. Consider the following example:
 * <br><br>
 ...
 */
 public class SomewhatModifier extends ModifierFunction implements Serializable
 {
    ...
    public SomewhatModifier(String s)
    {
        super( s );
    }
     ...
     * after the application of the <code>somewhat</code> modifier.  The somewhat modifier
     * raises the membership values of the points in the FuzzyValue to a power of 
     * <sup>1</sup>/<sub>2</sub>.
     *
     * @param fv the FuzzyValue to modify with the <code>somewhat</code> hedge
     * @return a new FuzzyValue object representing FuzzyValue argument after the 
     *         application of the <code>somewhat</code> hedge.  This new FuzzyValue 
     ...
     * <sup>1</sup>/<sub>2</sub>.
     *
     * @param fs the FuzzySet to modify with the <code>somewhat</code> hedge
     * @return a new FuzzySet object representing FuzzySet argument after the 
     *         application of the <code>somewhat</code> hedge.
     * @see ModifierFunction
     */
    public FuzzySet call(FuzzySet a){
        return(concentrateDilute(a, 1.0/2.0));
    }
